  ...
  return (
    <nav style={{
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span style={{ fontFamily: FONT.display, fontSize: "1.3rem", color: C.ink, fontStyle: "italic" }}>SB</span>
        ...
        <a href={user.resume} target="_blank" rel="noopener noreferrer" style={{
          ...
          background: C.ink, padding: "0.45rem 1rem", borderRadius: 4, letterSpacing: "0.04em", textDecoration: "none",
        }}>
          RESUME ↗
        </a>
      </div>
